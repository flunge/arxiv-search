\begin{table*}[t]
    \caption{\label{tab:benchmarks}
        \textbf{Novel view synthesis}: Results for our approach and baselines on a variety of novel view synthesis benchmarks. As a \textbf{ray tracing} algorithm, our method runs at similar speed to the rasterization-based baseline, and achieves comparable performance on all benchmarks.
    }
    \centering
    \small
